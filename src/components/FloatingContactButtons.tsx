...
export const FloatingContactButtons: React.FC = () => {
  return (
    <div
      ...
      className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-end select-none"
    >
      {/* Botón Instagram */}
      <div className="relative group flex items-center">
        <span
          className="hidden sm:inline-block absolute right-full mr-3 px-3 py-1.5 rounded-xl bg-gray-900/90 text-white text-xs font-medium tracking-wide shadow-lg whitespace-nowrap opacity-0 translate-x-2 pointer-events-none transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0"
        >
          Mensaje Directo en Instagram
        </span>
        <a
          href={CONTACT_INFO.instagramDmUrl}
          target="_blank"
