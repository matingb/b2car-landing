        ...
        <Reveal>
           ...
           <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <a
                ...
                className="inline-flex items-center justify-center w-full max-w-xs sm:w-72 h-14 px-4 sm:px-6 text-base sm:text-lg font-semibold rounded-lg text-white bg-[#25D366] hover:bg-[#20ba5a] shadow-lg shadow-[#25D366]/30 hover:scale-[1.02] active:scale-98 transition-all duration-200 whitespace-nowrap"
                aria-label="Contactar por WhatsApp"
              >
                <svg className="mr-2.5 w-5 h-5 fill-current shrink-0" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <Button
                ...
                className="w-full max-w-xs sm:w-72 h-14 px-4 sm:px-6 text-base sm:text-lg font-semibold bg-accent hover:bg-accent-hover text-white shadow-lg shadow-accent/25 hover:scale-[1.02] active:scale-98 transition-all duration-200 whitespace-nowrap"
                aria-label="Contactar ventas por email"
              >
                 <Mail className="mr-2.5 w-5 h-5 shrink-0" />
              ...
              <Button
                ...
                variant="ghost"
                onClick={handleCall}
                className="w-full max-w-xs sm:w-72 h-14 px-4 sm:px-6 text-base sm:text-lg font-semibold text-white border border-white/20 hover:bg-white/10 hover:scale-[1.02] active:scale-98 transition-all duration-200 whitespace-nowrap sm:hidden"
                aria-label="Llamar a ventas"
              >
                 <Phone className="mr-2.5 w-5 h-5 shrink-0" />
                 <span>Llamar ({CONTACT_INFO.phoneDisplay})</span>
              </Button>
           </div>
